 ...
 * 
 * Eğer bu düşüncenizde hatalıysanız/haksızsanız dart run-timeda bir hata fırlatır. Böylece programımız null hatalarına açılmış olur bu yüzden yüzde yüz kodunuzun null olmayacağından emin değilseniz bunu kullanmayın.
 * 
 * Özetle ! koydugunuzda dart'a şunu dersiniz: Biliyorum bu değişken null olabilir ama söz veriyorum ki null değer yok, o yüzden bunu null değer kabul etmeyen bir değişkene atayabilirsin.
 * 
