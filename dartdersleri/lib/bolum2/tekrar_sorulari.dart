...
/*
  ...
  print("\n");
  for (int i = 1; i <= 5; i++) {
    print("$i.inci döngüde ismim : Ömer Sonsuz");
  }
  print("\n");
  print("*************************************************");
  print("\n");
  int kontrol = 0;
  while (kontrol < 5) {
    print("${kontrol + 1}.inci döngüde ismim : Ömer Sonsuz");
    kontrol++;
  }
  print("\n");
  print("*************************************************");
  ...
  int kontrol1 = 0;
  do {
    print("${kontrol1 + 1}.inci döngüde ismim : Ömer Sonsuz");
    kontrol1++;
  } while (kontrol1 < 5);
  ...
  */
  ...
  for (i = 1; i <= sayi; i++) {
    print(
        "$i.inci döngüde , Sayi değeri: $sayi sayısının faktariyeli = ${sonuc = sonuc * i}");
  }*/
}
